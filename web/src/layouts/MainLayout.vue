...
import { LayoutDashboard, ListTodo, FileCode, Settings, LogOut, ScrollText, Terminal, Variable, KeyRound, Menu, X, Globe, Bell } from 'lucide-vue-next'
...
const sentence = ref(cachedSentence || '欢迎使用玄武面板')
