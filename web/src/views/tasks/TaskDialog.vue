...
import { Plus, ChevronDown, X, Search, Check, ChevronsUpDown, AlertCircle, Terminal, Zap, Loader2, Variable } from 'lucide-vue-next'
import TagInput from '@/components/TagInput.vue'
import { cn } from '@/lib/utils'
import { api, type Task, type EnvVar, type MiseLanguage } from '@/api'
...
watch(() => props.open, async (val: boolean) => {
  if (val) {
    ...
    workDir.value = normalizeLocalWorkDirForDisplay(props.task?.work_dir)
          ...
          <div class="space-y-10 py-6 pb-10">
            ...
            <section class="space-y-4">
              ...
              <div class="grid gap-5 pl-3 border-l border-muted">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-4 items-center gap-1 sm:gap-3 min-w-0">
                  ...
                  <div class="sm:col-span-3 min-w-0">
                      <Select v-model="selectedTriggerType">
                        ...
                        <SelectContent>
                          ...
                          <SelectItem :value="TRIGGER_TYPE.XUANWU_STARTUP" class="text-xs sm:text-sm">🚀 系统启动</SelectItem>
                        </SelectContent>
                      </Select>
                    </div>
                </div>
                          ...
                          <div v-for="env in filteredEnvVars" :key="env.id" @click.stop="addEnv(env.id)"
                            ...
                            <div class="flex items-center justify-between mb-1">
                              <div class="flex items-center gap-2 min-w-0">
                                <Variable class="h-3.5 w-3.5 shrink-0 text-blue-500/60" />
