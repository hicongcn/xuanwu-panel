...
<template>
    <div class="space-y-4">
        <XuanwuDialog v-model:open="showClearConfirm" title="清空系统事件确认">
        ...
        <XuanwuDialog v-model:open="detailDialogProps.open" :title="detailDialogProps.title" @update:open="onDialogClose">
